...
import flitsr.universalmutator.mutator as mutator

import flitsr.universalmutator.c_handler as c_handler
import flitsr.universalmutator.cpp_handler as cpp_handler
import flitsr.universalmutator.python_handler as python_handler
import flitsr.universalmutator.java_handler as java_handler
import flitsr.universalmutator.javascript_handler as javascript_handler
import flitsr.universalmutator.swift_handler as swift_handler
import flitsr.universalmutator.rust_handler as rust_handler
import flitsr.universalmutator.go_handler as go_handler
import flitsr.universalmutator.lisp_handler as lisp_handler
import flitsr.universalmutator.solidity_handler as solidity_handler
import flitsr.universalmutator.vyper_handler as vyper_handler
import flitsr.universalmutator.fe_handler as fe_handler
import flitsr.universalmutator.r_handler as r_handler
import flitsr.universalmutator.fortran_handler as fortran_handler
...
def main():
    ...
    for mutant in mutants:
        if (lineFile is not None):
            if ((not comby and mutant[0] not in lines) or (comby and
                 not any(line in range(*mutant[3]) for line in lines))):
