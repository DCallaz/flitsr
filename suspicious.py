...
class Suspicious() :
    ...
    def hyperbolic(self):
        ...
        K2 = 0.768
        K3 = 0.711
        t1 = math.inf if (self.nf == 0) else 1/(K1 + (self.nf/self.tf))
        t2 = math.inf if (self.ep == 0) else K3/(K2 + self.ep/(self.ef + self.ep))
        return t1 + t2
